...
import { selectedModelAtom, searchEnabledAtom, type Model } from '@/lib/atoms';
    ...
    <div className="relative">
      ...
      >
        <div className="flex items-center gap-2 min-w-0">
          ...
          {selectedModel.supports_search && searchEnabled && (
      ...
      {isOpen && (
        <>
          ...
          <div className="absolute bottom-full left-0 mb-1 w-80 bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 rounded-md shadow-lg z-50 max-h-96 overflow-y-auto">
            <div className="p-2">
