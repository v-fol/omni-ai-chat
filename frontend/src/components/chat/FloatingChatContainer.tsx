...
import { chatPositionAtom, isAutoScrollAtom, searchEnabledAtom, selectedModelAtom, sidebarCollapsedAtom } from '@/lib/atoms';
import { LayoutGrid, Sun, Moon, Search, ArrowDown, User, Bot } from 'lucide-react';
      ...
      <Tooltip>
        <TooltipTrigger asChild>
          <Button 
            ...
            className="rounded-full size-8 hover:bg-neutral-200 dark:hover:bg-neutral-700"
          >
        ...
        <TooltipTrigger asChild>
          <Button 
            ...
            className={cn(
              ...
              !searchEnabled && "hover:bg-neutral-200 dark:hover:bg-neutral-700",
    ...
    <div className={config.containerClass}>
      <div className={cn(
        ...
        config.showNavigation && 'min-h-[500px]' // Ensure minimum height for navigation
            ...
            {messages.length === 0 && (
                <ShineBorder className='opacity-50' shineColor={["#A07CFE", "#FE8FB5", "#FFBE7B"]} />
            )}


        
        <div className={cn(config.innerClass, config.showNavigation && 'h-full', 'relative z-10')}>
